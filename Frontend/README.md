...
- `/matches`: Displays the Matches page.
- `/commande`: Displays the Commande page.
- `/parametre`: Displays the Paramètre page.
- `/users`: Displays the Utilisateur page.
- `/ventes`: Displays the Ventes page.
